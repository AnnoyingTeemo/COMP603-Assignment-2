...
public class Monk extends Ally{
    ...
    public Monk(Item leftHand, Item rightHand){
        super(50, 15, 0, 0, 0, 5, leftHand, rightHand, new DamageItem("Punch", 4, 3, DamageTypes.DamageType.Blunt, 0), new DefensiveItem("Prepare Body", BuffTypes.Buffs.DamageReduction, 6, 1, 0), "Monk");
        calculateAbilities();
    }
